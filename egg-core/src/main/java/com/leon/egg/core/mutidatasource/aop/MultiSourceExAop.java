package com.leon.egg.core.mutidatasource.aop;
...
import com.leon.egg.core.mutidatasource.DataSourceContextHolder;
import com.leon.egg.core.mutidatasource.annotion.DataSource;
...
public class MultiSourceExAop implements Ordered {
	...
	@Pointcut(value = "@annotation(com.leon.egg.core.mutidatasource.annotion.DataSource)")
	private void cut() {
